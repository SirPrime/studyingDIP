package exCap17;// Exercise 17.3 about Bilateral filters
...
public class Ex17_3 {
    ...
    public static void main(String[] args) {
        ...
        new FileSaver(im2).saveAsPng("coloreando/img/filters.Bilateral.png");

        // filters.Bilateral separable soloX
//        filters.Bilateral bl = new filters.Bilateral(im, 2, 20);
//        ImagePlus im2 = bl.filter1D(im, 'X');
//        new FileSaver(im2).saveAsPng("coloreando/img/BilateralSoloX.png");

        // filters.Bilateral separable soloX
//        filters.Bilateral bl = new filters.Bilateral(im, 2, 20);
//        ImagePlus im2 = bl.filter1D(im, 'Y');
//        new FileSaver(im2).saveAsPng("coloreando/img/BilateralSoloY.png");

        // filters.Bilateral separable
//        filters.Bilateral bl = new filters.Bilateral(im, 2, 20);
//        ImagePlus im2 = bl.filterSeparable('Y');
//        new FileSaver(im2).saveAsPng("coloreando/img/BilateralSeparable.png");
